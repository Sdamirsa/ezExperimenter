...
with col_code:
    generate_code_button = st.button("Provide the raw code", help="Generate Python code that reproduces these experiment configurations.", type="primary")
...
if generate_code_button:
    ...
    code_lines = []
    code_lines.append("# ezExperimenter :)")
    code_lines.append("")
    code_lines.append("# download the pre-made functions from my github: https://github.com/Sdamirsa/ezExperimenter")
    code_lines.append("!git clone https://github.com/Sdamirsa/ezExperimenter")
    code_lines.append("# Move contents of 'ezExperimenter' folder to the current directory and delete the folder.")
